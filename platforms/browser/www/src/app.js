...
setTimeout(function(){RuntimeDataFactory.charities.push(new Charity(30,"Hes the beacon", "Over here", "b"));console.log("Run");console.log(RuntimeDataFactory.charities);}, 7000);
