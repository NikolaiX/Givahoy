...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAIQ45NH5IGW5DIKOQ',
            secretKey: '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',
            sessionToken: '',
            region: '',
            apiKey: undefined,
    ...
    var endpoint = 'https://v6lzwdp16i.execute-api.eu-west-1.amazonaws.com/prod';
    ...
    apigClient.locationGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var locationGetRequest = {
        ...
        return apiGatewayClient.makeRequest(locationGetRequest, authType, additionalParams, config.apiKey);
    };
